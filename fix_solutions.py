...
files = {
    "c/81_easy_number_challenge_236B.c": r"""#include <stdio.h>
...
""",
    "cpp/81_easy_number_challenge_236B.cpp": r"""#include <bits/stdc++.h>
using namespace std;
...
""",
    "python/81_easy_number_challenge_236B.py": r"""def divisor_count(x: int) -> int:
    cnt = 0
    d = 1
    while d * d <= x:
        if x % d == 0:
...
""",
    "c/82_pythagorean_theorem_ii_304A.c": r"""#include <stdio.h>
#include <math.h>
...
""",
    "cpp/82_pythagorean_theorem_ii_304A.cpp": r"""#include <bits/stdc++.h>
using namespace std;
...
""",
    "python/82_pythagorean_theorem_ii_304A.py": r"""import math
...
print(count)
""",
    "c/83_cards_with_numbers_254A.c": r"""#include <stdio.h>
#include <stdlib.h>
...
""",
    "cpp/83_cards_with_numbers_254A.cpp": r"""#include <bits/stdc++.h>
using namespace std;
...
""",
    "python/83_cards_with_numbers_254A.py": r"""import sys
...
""",
    "c/84_domino_353A.c": r"""#include <stdio.h>
#include <stdlib.h>
...
""",
    "cpp/84_domino_353A.cpp": r"""#include <bits/stdc++.h>
using namespace std;
...
""",
    "python/84_domino_353A.py": r"""n = int(input().strip())
...
""",
    "c/85_cinema_line_349A.c": r"""#include <stdio.h>
...
""",
    "cpp/85_cinema_line_349A.cpp": r"""#include <bits/stdc++.h>
using namespace std;
...
""",
    "python/85_cinema_line_349A.py": r"""n = int(input().strip())
...
for x in arr:
    ...
    print('YES')
""",
    "c/86_rank_list_166A.c": r"""#include <stdio.h>
#include <stdlib.h>
...
""",
    "cpp/86_rank_list_166A.cpp": r"""#include <bits/stdc++.h>
using namespace std;
...
""",
    "python/86_rank_list_166A.py": r"""n, k = map(int, input().split())
contestants = []
for _ in range(n):
...
""",
    "c/87_cut_ribbon_189A.c": r"""#include <stdio.h>
#include <limits.h>
...
""",
    "cpp/87_cut_ribbon_189A.cpp": r"""#include <bits/stdc++.h>
using namespace std;
...
""",
    "python/87_cut_ribbon_189A.py": r"""n, a, b, c = map(int, input().split())
dp = [-(10**9)] * (n + 1)
dp[0] = 0
for i in range(1, n + 1):
    if i >= a:
...
print(dp[n])
""",
    "c/88_iq_test_287A.c": r"""#include <stdio.h>
...
""",
    "cpp/88_iq_test_287A.cpp": r"""#include <bits/stdc++.h>
using namespace std;
...
""",
    "python/88_iq_test_287A.py": r"""grid = [input().strip() for _ in range(4)]
for i in range(3):
    for j in range(3):
...
print('NO')
""",
    "c/89_building_permutation_285C.c": r"""#include <stdio.h>
#include <stdlib.h>
...
""",
    "cpp/89_building_permutation_285C.cpp": r"""#include <bits/stdc++.h>
using namespace std;
...
""",
    "python/89_building_permutation_285C.py": r"""n = int(input().strip())
a = list(map(int, input().split()))
a.sort()
print(sum(abs(x - i) for i, x in enumerate(a, start=1)))
""",
    "c/90_kuriyama_mirai_stones_433B.c": r"""#include <stdio.h>
#include <stdlib.h>
...
""",
    "cpp/90_kuriyama_mirai_stones_433B.cpp": r"""#include <bits/stdc++.h>
using namespace std;
...
""",
    "python/90_kuriyama_mirai_stones_433B.py": r"""n, q = map(int, input().split())
a = list(map(int, input().split()))
b = sorted(a)
pref = [0] * (n + 1)
pref_sorted = [0] * (n + 1)
